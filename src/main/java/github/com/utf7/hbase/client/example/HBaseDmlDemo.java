...
import github.com.utf7.hbase.client.example.util.DataUtil;
...
public class HBaseDmlDemo {
    ...
    public int put() throws IOException {
        ...
        try (Table table = connection.getTable(tableName)) {
            Put put = new Put(Bytes.toBytes(
                    RandomUtils.nextInt(0, 10) + "-row-" + UUID.randomUUID().toString()));
    ...
    public int batchPuts() throws IOException {
        ...
        LOG.info("finish batch put data to table {}  rows {} and cost {} ms", tableName.getNameAsString(), ROWS,
                (System.currentTimeMillis() - start));
